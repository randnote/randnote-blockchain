...
const keyGenerator = () => {
	...
	let keyPair = ec.genKeyPair(); // Generate random keys... both the public and private
	// console.log(keyPair)

	const privKey = keyPair.getPrivate(); // get the private key
	...
	// console.log(pubKey)
	let newpubKey = pubKey.encode("hex"); // the hex version of the public key
