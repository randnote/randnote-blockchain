...
var allocationAmount = 10000; // 10 k
var getAutoGeneratedUsers = function () {
    axios_1.default.get("http://localhost:8024/userfindAutoGens").then(function (response) { return __awaiter(void 0, void 0, void 0, function () {
        var usersArray, i;
        return __generator(this, function (_a) {
            ...
            for (i = 0; i < response.data; i++) {
                index_1.note.pendingTransactions.push(new transaction_1.default(null, response.data[i], allocationAmount));
            }
            return [2 /*return*/];
        });
    }); });
...
//# sourceMappingURL=autoFundsAllocator.js.map